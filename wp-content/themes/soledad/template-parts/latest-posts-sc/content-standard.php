...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="standard-content">
		...
		<?php if ( 'yes' != $standard_share_box || 'yes' != $standard_date || 'yes' != $standard_comment ) : ?>
			<div class="penci-post-box-meta<?php if( 'yes' == $standard_share_box || ( 'yes' == $standard_date && 'yes' == $standard_comment ) ): echo ' center-inner'; endif; ?>">
				<?php if ( 'yes' != $standard_date || 'yes' != $standard_comment ) : ?>
