...
class PenciCustomSliders extends Base_Widget {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'arrows_position',
			array(
				'label'     => __( 'Arrows Position', 'soledad' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'inside',
				'options'   => array(
					'inside'  => __( 'Inside', 'soledad' ),
					'outside' => __( 'Outside', 'soledad' ),
				),
				'condition' => array(
					'navigation' => array( 'arrows', 'both' ),
				),
		...
		$this->add_control(
			'dots_position',
			array(
				'label'     => __( 'Dots Position', 'soledad' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'inside',
				'options'   => array(
					'outside' => __( 'Outside', 'soledad' ),
