	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array( '{{WRAPPER}} .penci-heading-title' => 'color: {{VALUE}};' ),
			)
		);
		$this->add_group_control(
			Group_Control_Typography::get_type(), array(
	...
	protected function render() {
		...
		<div class="penci-fancy-heading penci-heading-text-<?php echo esc_attr( $settings['_text_align'] ); ?>">
			<div class="penci-fancy-heading-inner">
				...
				if ( $settings['p_title'] ) {
					echo '<' . esc_attr( $settings['title_tag'] ) . ' class="penci-heading-title">' . $settings['p_title'] . '</' . esc_attr( $settings['title_tag'] ) . '>';
				}
