	...
	public function register_block_title_style_section_controls() {
		...
		$this->add_control(
			'btitle_style10_btopcolor', array(
				...
				'condition' => array( 'heading_title_style' => array( 'style-10' ) ),
			)
		);
		...
		$this->add_control(
			'btitle_shapes_color', array(
				...
				'selectors' => array(
					...
					'{{WRAPPER}} .penci-homepage-title' => 'background-color: {{VALUE}};',
				),
				'condition' => array( 'heading_title_style' => array( 'style-13','style-11','style-12','style-14' ) ),
			)
		);
		$this->add_control(
		...
		$this->add_control(
			'btitle_style9_bgimg', array(
				...
				'condition' => array( 'heading_title_style' => array( 'style-8' ) ),
			)
		);
