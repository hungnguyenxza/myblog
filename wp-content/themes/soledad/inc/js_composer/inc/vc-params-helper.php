	...
	class Penci_Vc_Params_Helper {
		...
		public static function params_heading_typo_color( $group_color = '' ) {
			...
			return array(
				...
				array(
					'type'             => 'colorpicker',
					'heading'          => esc_html__( 'Background Shapes for Heading Style 11, 12, 13, 14', 'soledad' ),
					'param_name'       => 'btitle_shapes_color',
					'group'            => $group_color,
					'edit_field_class' => 'vc_col-sm-6',
					'dependency'       => array( 'element' => 'heading_title_style', 'value' => array( 'style-13', 'style-11', 'style-12','style-14' ) ),
				),
