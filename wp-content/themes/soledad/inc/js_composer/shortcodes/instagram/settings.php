	...
	'params'        => array_merge(
		array(
			...
			array(
				...
				'description' => 'Please fill the Instagram Access Token here. You can get Instagram Access Token via <a href="http://instagram.pixelunion.net/" target="_blank">http://instagram.pixelunion.net/</a>',
				'dependency' => array( 'element' => 'search_for', 'value' => array( 'username' ) ),
			),
			array(
				'type'       => 'textfield',
