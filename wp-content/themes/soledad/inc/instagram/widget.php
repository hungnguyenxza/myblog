		...
		function form( $instance ) {
			...
			<div class="penci-instagram-container">
				...
				<p class="<?php if ( 'username' != $instance['search_for'] ) {echo 'hidden';} ?>">
					...
					<span class="penci-description">Please fill the Instagram Access Token here. You can get Instagram Access Token via <a href="http://instagram.pixelunion.net/" target="_blank">http://instagram.pixelunion.net/</a></span>
				</p>
