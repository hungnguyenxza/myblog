...
if ( ! function_exists( 'penci_soledad_get_list_new_demo' ) ):
	function penci_soledad_get_list_new_demo() {
		$new_demo_listing = array(
			'lifestyle-news-2sb'        => 'Lifestyle News Two Sidebars',
			'travel-news-2sb'           => 'Travel News Two Sidebars',
			'fashion-news-2sb'          => 'Fashion News Two Sidebars',
			'food-news-2sb'             => 'Food News Two Sidebars',
			'game-news-2sb'             => 'Game News Two Sidebars',
			'fitness-news-2sb'          => 'Fitness News Two Sidebars',
			'beauty-cosmetics-news-2sb' => 'Beauty & Cosmetics News',
			'travel-agency-mul'         => 'Travel Agency  Multipurpose',
			'spa-wellness-mul'          => 'Spa & Wellness Center  Multipurpose',
			'business-mul'              => 'Business Multipurpose  Multipurpose',
			'restaurant-mul'            => 'Restaurant Multipurpose  Multipurpose',
			'fitness-center-mul'        => 'Fitness Center  Multipurpose',
			'barber-shop-mul'           => 'Barber Shop Multipurpose',
			'ceramics-art-mul'          => 'Ceramics Art Multipurpose',
			'fashion-stylist-mul'       => 'Fashion Stylist Multipurpose',
			'construction-business-mul' => 'Construction Business Multipurpose',
			'coffee-shop-mul'           => 'Coffee Shop Multipurpose',
			'web-studio-mul'            => 'Web Studio Multi-purpose',
			'wedding-studio-mul'        => 'Wedding Studio Multi-purpose',
			'tailor-shop-mul'           => 'Tailor Shop – Multi-purpose',
		);

		$demo_configs = array();
		foreach ( $new_demo_listing as $key => $label ) {
			$config = array(
				'name'       => $label,
				'content'    => 'https://soledad-new-data.s3.amazonaws.com/' . $key . '/demo-content.xml',
				'widgets'    => 'https://soledad-new-data.s3.amazonaws.com/' . $key . '/widgets.wie',
